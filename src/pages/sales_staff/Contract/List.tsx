...
import { FileText, Calendar, Building2, Briefcase, DollarSign, Link2, Filter, Search, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="flex bg-gray-50 min-h-screen">
      ...
      <div className="flex-1 p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Hợp Đồng Với DevPool</h1>
                ...
                >
                  ...
                  <div className="space-y-3 text-gray-700">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>{formatCurrency(contract.totalClientRatePerMonth)}/tháng</span>
                    </div>
