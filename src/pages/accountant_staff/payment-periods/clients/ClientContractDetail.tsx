                    ...
                    <div className="p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="bg-neutral-50 rounded-lg p-3 border border-neutral-200">
                                ...
                                {contract ? (
                                    <Link
                                        to={`/accountant/contracts/clients/${contract.id}`}
                                                ...
                                                <div className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-xl hover:border-primary-400 hover:bg-primary-50 transition-colors">
                                                    {worksheetFile ? (
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="text-sm font-medium text-gray-700">{worksheetFile.name}</span>
                                                        </div>
                                                    ) : (
                                            ...
                                            <div className="mt-2">
                                                <div className="w-full bg-gray-200 rounded-full h-2">
                                                    <div
                                                        ...
                                                        style={{ width: `${worksheetUploadProgress}%` }}
                                                    />
                                                </div>
                                                <p className="text-xs text-gray-500 mt-1">Đang tải: {worksheetUploadProgress}%</p>
                                            </div>
                                        )}
                                    </div>
