...
export default function MarketListPage() {
  ...
  const startItem = filteredMarkets.length > 0 ? startIndex + 1 : 0;
  const endItem = Math.min(endIndex, filteredMarkets.length);
                ...
                {filteredMarkets.length > 0 ? (
                  <>
                    ...
                    <span className="text-sm text-neutral-600">
                      {startItem}-{endItem} trong số {filteredMarkets.length}
                    </span>
                  ...
                  <span className="text-sm text-neutral-600">Tổng: 0 thị trường</span>
                )}
              </div>
            </div>
          </div>
