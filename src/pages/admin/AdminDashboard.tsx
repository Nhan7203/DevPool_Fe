...
const sidebarItems = [
  { label: 'Tổng Quan Hệ Thống', href: '/admin/dashboard', icon: BarChart3 },
  { label: 'Quản Lý Người Dùng', href: '/admin/users', icon: Users },
  { label: 'Giám Sát Dự Án', href: '/admin/projects', icon: FolderOpen },
  { label: 'Quản Lý Hợp Đồng', href: '/admin/contracts', icon: FileText },
  { label: 'Xử Lý Thanh Toán', href: '/admin/payments', icon: CreditCard },
  { label: 'Báo Cáo & Phân Tích', href: '/admin/reports', icon: BarChart3 },
  { label: 'Cài Đặt Hệ Thống', href: '/admin/settings', icon: Settings },
  { label: 'Hỗ Trợ Khách Hàng', href: '/admin/support', icon: HelpCircle },
];
