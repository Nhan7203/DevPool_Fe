...
import { Search, Filter, FileText, Calendar, UserCheck, Clock } from 'lucide-react';
    ...
    return (
        <div className="flex bg-gray-50 min-h-screen">
            ...
            <div className="flex-1 p-8">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900">Danh Sách Hợp Đồng</h1>
                    <p className="text-neutral-600 mt-1">Quản lý và theo dõi các hợp đồng</p>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {contracts.map((contract) => (
                            <div key={contract.id} className="bg-white rounded-2xl shadow-soft hover:shadow-medium p-6 border border-gray-200 transition-all duration-300">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center gap-2 text-gray-600">
                                        ...
                                        <span>{new Date(contract.startDate).toLocaleDateString('vi-VN')} - {new Date(contract.endDate).toLocaleDateString('vi-VN')}</span>
                                    </div>
