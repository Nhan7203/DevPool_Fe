...
export default function ApplyProcessTemplateCreatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await applyProcessTemplateService.create({
        name: form.name,
        description: form.description || undefined,
      });
      setSuccess(true);
      setTimeout(() => navigate("/hr/apply-process-templates"), 1500);
    } catch (err) {
      console.error("❌ Error creating Apply Process Template:", err);
        ...
        <div className="mb-8 animate-slide-up">
          ...
          <div className="flex justify-between items-start">
            <div className="flex-1">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Tạo template quy trình Apply mới</h1>
              <p className="text-neutral-600 mb-4">
                Nhập thông tin để tạo template quy trình tuyển dụng mới
              </p>
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="VD: Quy trình tuyển dụng Senior Developer"
                  required
              ...
              {success && (
                <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-center gap-3">
                  ...
                  <p className="text-green-700 font-medium">
                    ✅ Tạo template thành công! Đang chuyển hướng...
                  </p>
                </div>
              )}
            </div>
