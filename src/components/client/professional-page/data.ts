...
export const mockProfessionals: Professional[] = [
  {
    ...
    workingMode: "Hybrid",
    status: "Working",
    bio: "Chuyên gia phát triển ứng dụng web với 8+ năm kinh nghiệm. Đã hoàn thành 200+ dự án thành công cho các startup và doanh nghiệp lớn.",
    hourlyRate: 800000,
    rating: 4.9,
    reviewCount: 127,
    skills: [
      { name: "ReactJS", level: "Chuyên gia", yearsExp: 5 },
      { name: "NodeJS", level: "Chuyên gia", yearsExp: 6 },
      { name: "MongoDB", level: "Giỏi", yearsExp: 4 },
      { name: "TypeScript", level: "Giỏi", yearsExp: 3 },
    ],
  ...
  },
  {
    ...
    workingMode: "Remote",
    status: "Working",
    bio: "Chuyên gia phát triển ứng dụng di động cross-platform. Tập trung vào UX/UI và performance optimization cho mobile apps.",
    hourlyRate: 750000,
    rating: 4.8,
    reviewCount: 89,
    skills: [
      { name: "Flutter", level: "Chuyên gia", yearsExp: 4 },
      { name: "React Native", level: "Giỏi", yearsExp: 3 },
      { name: "Firebase", level: "Chuyên gia", yearsExp: 5 },
      { name: "Kotlin", level: "Khá", yearsExp: 2 },
    ],
    availability: "busy",
